...
{										 // bsp-board support package
	RCC->AHB1ENR |= RCC_AHB1ENR_GPIODEN| RCC_AHB1ENR_GPIOAEN;; // enable GPIOD clock port for the LEDs and GPIOA for testing
	...
	GPIOA->OSPEEDR |= (3U << 2U * TEST_PIN);  // Medium speed (you can adjust speed as needed)
